...
eval_file_path = "../../dataset/road-euroroad.xlsx"  # 評估圖檔路徑

# === 啟動訓練環境（使用隨機 ER 圖） ===
train_env = MultiAgentTSPEnv(num_nodes=1175, num_agents=1, total_budget=50, individual_budget=100)
...
# 使用相同設定建立一個空白環境
eval_env = MultiAgentTSPEnv(num_nodes=1175, num_agents=1, total_budget=50, individual_budget=100)
# 載入固定評估圖
