...
def main():
    ...
    for i in range(len(configs)):
        ...
        for seed in args.seeds:
            ...
            train_df = train(num_agents=num_agents, total_budget=t_budget, per_agent_budget=i_budget, n_nodes=num_nodes, n_edges=num_edges, n_episodes=num_episodes, is_dynamic=is_dynamic)           
